...
function filterOptions(yargs) {
  ...
  const opts = {
    ...
    "no-private" : {
      describe :
          'Exclude packages with { "private": true } in their package.json.',
      type : "boolean",
    },
    private : {
  ...
  return yargs.options(opts)
      ...
      .check(argv => {
        ...
        if (argv.includeFilteredDependents) {
          ...
          log.warn(
              "deprecated",
              "--include-filtered-dependents has been renamed --include-dependents");
        }
        ...
        if (argv.includeFilteredDependencies) {
          ...
          log.warn(
              "deprecated",
              "--include-filtered-dependencies has been renamed --include-dependencies");
        }
